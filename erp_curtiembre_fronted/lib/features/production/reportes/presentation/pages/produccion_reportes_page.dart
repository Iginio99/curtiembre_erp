...
class _HeroCard extends StatelessWidget {
  const _HeroCard({required this.totalClientes, required this.totalOrdenes});
        ...
        children: [
          ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Controla avance operativo, consumo, merma y tiempos desde una sola vista.',
                ...
                Text(
                  'Este bloque esta pensado para lectura y seguimiento. Ajusta filtros por cliente, orden o proceso segun el reporte que estes auditando.',
          ...
          Wrap(
            ...
            children: [
              _HeroMetric(label: 'Clientes activos', value: '$totalClientes'),
              _HeroMetric(label: 'Ordenes cargadas', value: '$totalOrdenes'),
              const _HeroMetric(label: 'Bloques', value: '5'),
            ],
          ),
        ],
      ),
